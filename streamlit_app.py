...
with tab1:
    ...
    with col1:
        ...
        fig = px.bar(merchant_trans, title="Top Merchants by Transactions")
...
insights = """
1. **Dominant Merchants**: Some merchants show exceptionally high transaction volumes and amounts.
2. **Device Usage**: Certain devices handle the majority of high-value transactions.
3. **Card Patterns**: Some masked cards show frequent high-value transactions.
4. **Anomalies**: Investigate transactions with $0 amounts.
5. **Revenue Concentration**: Top merchants may account for the majority of total transaction value.
"""
st.write(insights)
